...
copyright = u'2012, pyIDLastro Contributors'
...
latex_documents = [
  ('index', 'pyIDLastro.tex', u'pyIDLastro Documentation',
   u'pyIDLastro Collaboration', 'manual'),
]
...
man_pages = [
    ('index', 'pyidlastro', u'pyIDLastro Documentation',
     [u'pyidlAstro Collaboration'], 1)
]
